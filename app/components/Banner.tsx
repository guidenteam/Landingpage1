...
export default function Banner() {
  return (
    <div className="flex flex-col space-y-3 lg:flex-row m-10">
      ...
      <div className="w-full lg:w-1/2 justify-end flex space-x-3 h-[500px] overflow-hidden">
        <div className="w-full lg:w-1/3 flex flex-col space-y-2">
          <Image className="" src={banner1} alt="" />
          <Image className="" src={banner3} alt="" />
        </div>
        <div className="w-full lg:w-1/3 flex flex-col space-y-2">
          <Image className="" src={banner2} alt="" />
          <Image className="" src={banner4} alt="" />
        </div>
      </div>
    </div>
  );
...
export const SwiperCard = () => {
  ...
  return (
    <Swiper
      ...
      className="swiper"
    >
      <SwiperSlide className="flex flex-col space-y-3 mx-5">
      ...
      <SwiperSlide className="flex flex-col space-y-3">
        ...
        <p className="sm:text-justify text-sm sm:text-base">
          ...
          We believe technology can simplify communication and empower parents,
          leading to a more enjoyable and fulfilling parenting journey.
        </p>
        <div className="flex items-center space-x-3">
